var vzUrl={regex:new RegExp("^((https?|ftp)://[\\w\\-_]+(\\.[\\w\\-_]+)+|/)([\\w\\-\\.,@?^=%&amp;:/~\\+#]*[\\w\\-\\@?^=%!&amp;/~\\+#])?$","gi"),init:function(a){$("#publish").on("keyup paste",".vz_url_field",function(b){vzUrl.check_field.call(b.target,true);
});$(".vz_url_field").each(vzUrl.check_field);if(typeof Matrix!=="undefined"){Matrix.bind("vz_url","display",function(b){vzUrl.check_field.call($(this).find("input"));
