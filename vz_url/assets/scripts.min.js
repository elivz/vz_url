...
f.removeClass("empty checking invalid valid nonlocal redirect").addClass(d);switch(d){case"empty":case"checking":case"valid":break;case"invalid":c.html("<span>"+vzUrl_settings.errorText+"</span>");
break;case"nonlocal":c.html("<span>"+vzUrl_settings.nonlocalText+"</span>");break;case"redirect":c.html("<span>"+vzUrl_settings.redirectText+" "+e.final_url+"</span>");
...
return false;}}).appendTo(c);break;}},not_natively_supported:(function(){var c=document.createElement("input");return !("pattern" in c);})()};a.init();
});